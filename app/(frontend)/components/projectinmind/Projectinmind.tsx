...
export default function Projectinmind() {
  return (
    <div className="pt-20 bg-[#EDEEEF] dark:bg-matteblack min-h-[40vh] sm:min-h-[50vh] flex flex-col items-center relative">
      <div className="absolute inset-0 z-0">
        <div
          className="w-full h-full bg-cover bg-center bg-no-repeat dark:invert"
          style={{
            backgroundImage: "url('/images/bgteams.png')", // Replace with your image path
